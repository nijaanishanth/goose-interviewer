...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <Card variant="glass" className="p-12 max-w-2xl text-center relative z-10 animate-fade-in hover:shadow-2xl hover:-translate-y-2 smooth-transition">
        <div className="mb-4 smooth-transition hover:scale-110">
          <span className="text-6xl">🪿</span>
        </div>
        <h1 className="text-5xl font-bold mb-4 text-lake-blue smooth-transition">
          Goose Interview Coach
        </h1>
        <p className="text-lg text-foreground/80 mb-8 smooth-transition">
